...
def _mnist(
    ...
    trainset = torchvision.datasets.MNIST(
        ...
        train=True,
        download=True,
        transform=transform_totensor,
    )
    trainloader = torch.utils.data.DataLoader(
        trainset, batch_size=batchsize, shuffle=True, num_workers=nworkers
    )
    ...
    testloader = torch.utils.data.DataLoader(
        testset, batch_size=testbatchsize, shuffle=False, num_workers=nworkers
    )
